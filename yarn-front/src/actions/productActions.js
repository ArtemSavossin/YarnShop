...
export const listProductsYarn = (pageNumber = '') => async (dispatch) => {
  try {
    ...
    dispatch({
      type: PRODUCT_LIST_YARN_SUCCESS,
      payload: data,
    });
  } catch (e) {
    dispatch({
      type: PRODUCT_LIST_YARN_FAIL,
      payload:
        e.response && e.response.data.message
          ? e.response.data.message
          : e.message,
...
export const listProductsHooks = (pageNumber = '') => async (dispatch) => {
  try {
    ...
    dispatch({
      type: PRODUCT_LIST_HOOKS_SUCCESS,
      payload: data,
    });
  } catch (e) {
    dispatch({
      type: PRODUCT_LIST_HOOKS_FAIL,
      payload:
        e.response && e.response.data.message
          ? e.response.data.message
          : e.message,
...
export const listProductsSets = (pageNumber = '') => async (dispatch) => {
  try {
    ...
    dispatch({
      type: PRODUCT_LIST_SETS_SUCCESS,
      payload: data,
    });
  } catch (e) {
    dispatch({
